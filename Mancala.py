...
class Game:
    ...
    def check_for_victory(self):
        # Add code here to check for winning condition and update the self.victory variable accordingly
        # In this case, use a for loop to step through the first half of playing_area (0-5) and count if there are stones
        # in there. Repeat for the other side (7-12). Don't count the stores in this.
...
def print_rules():
    ...
    print("The Mancala 'board' is made up of two rows of six holes, or pits, each. "
          "Next, four pieces -- marbles or stones -- are placed in each of the 12 holes. The color of the pieces is irrelevant.")
    print("Each player has a 'store' to the side of the Mancala board. The number of stones in your store is your score.")
    ...
    print("3. If the last piece you drop is in an empty hole on your side, you capture that piece and any pieces in the hole directly opposite.")
